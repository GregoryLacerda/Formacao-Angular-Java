package com.gregory.helpdesk.domain.dtos;
...
public class TecnicoDTO implements Serializable{
	...
	@NotNull(message = "O campo NOME é requerido") //para que não aceite mais que o campo seja null e passa uma mensagem caso seja
